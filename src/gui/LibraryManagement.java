...
public class LibraryManagement extends JFrame {
	...
	public LibraryManagement() {
		...
		ConferenceProceeding cp = new ConferenceProceeding();
				...
				btnNewButton_4.addMouseListener(new MouseAdapter() {
					public void mouseClicked(MouseEvent e) {
						//fuzzy search for readerId or readerName, and show result
						//TODO
					}
				});
				...
				btnSearch.addMouseListener(new MouseAdapter() {
					public void mouseClicked(MouseEvent e) {
						//fuzzy search for publisher name, author name, title or descriptor and show result
						//TODO
					}
				});
		...
		R_add.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		panel_N_Reader.add(lblType);
				...
				panel_N_Reader.add(lblReadername_ReaderName);
						...
						lblPhonenum.setBounds(481, 63, 70, 14);
						...
						textField_R_PhoneNum.setColumns(10);
								...
								textField_D_ISBN.setColumns(10);
										...
										D_add.setFont(new Font("Times New Roman", Font.PLAIN, 13));
										...
										L_add.setFont(new Font("Times New Roman", Font.PLAIN, 13));
										...
										JLabel lblNewLabel_1 = new JLabel("Library Name");
										lblNewLabel_1.setFont(new Font("Arial", Font.PLAIN, 11));
										lblNewLabel_1.setBounds(64, 65, 64, 14);
										...
										lblPosition.setBounds(115, 257, 74, 14);
										
										textField_C_Position = new JTextField();
										textField_C_Position.setBounds(115, 281, 87, 36);
										...
										btnSearch_1.setForeground(Color.BLUE);
										btnSearch_1.setFont(new Font("Times New Roman", Font.PLAIN, 13));
										btnSearch_1.addMouseListener(new MouseAdapter() {
											public void mouseClicked(MouseEvent arg0) {
												//search for doc name and choose one
												//TODO
												
											}
										});
										btnSearch_1.setBounds(542, 90, 87, 36);
										...
										btnSearch_2.setForeground(Color.BLUE);
										btnSearch_2.setFont(new Font("Times New Roman", Font.PLAIN, 13));
										btnSearch_2.setBounds(542, 185, 87, 36);
										panel_N_Copy.add(btnSearch_2);
										
										JButton C_add = new JButton("ADD");
										C_add.addMouseListener(new MouseAdapter() {
											public void mouseClicked(MouseEvent e) {
												//after select doc name and library name, add position
												//TODO
											}
										});
										C_add.setForeground(Color.BLUE);
										C_add.setFont(new Font("Times New Roman", Font.PLAIN, 13));
										C_add.setBounds(542, 281, 87, 36);
			...
			//Search for existing readerID and if they are same, update type, name, address and phone number
			//TODO
			...
			btnUpdate_2.setFont(new Font("Times New Roman", Font.PLAIN, 13));
			...
			//Search for library branch Id, if they are same, update library name and library location
			//TODO
			...
			btnUpdate_1.setFont(new Font("Times New Roman", Font.PLAIN, 13));
