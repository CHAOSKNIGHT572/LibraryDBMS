...
--
-- Table structure for table `chief_editior`
--

DROP TABLE IF EXISTS `chief_editior`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chief_editior` (
  `ce_id` int(11) NOT NULL AUTO_INCREMENT,
  `ce_name` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ce_id`)
...
CREATE TABLE `document` (
  ...
  `type` int(1) NOT NULL COMMENT '0: Book\n1: Journal Volume\n2: Conference Proceeding',
...
CREATE TABLE `journal_issue` (
  ...
  CONSTRAINT `issue_volume_id` FOREIGN KEY (`doc_id`) REFERENCES `journal_volume` (`doc_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `journal_volume` (
  `doc_id` int(11) NOT NULL,
  `jv_editor` int(11) DEFAULT NULL,
  PRIMARY KEY (`doc_id`),
  KEY `volume_editor_id_idx` (`jv_editor`),
  CONSTRAINT `volume_document_id` FOREIGN KEY (`doc_id`) REFERENCES `document` (`doc_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `volume_editor_id` FOREIGN KEY (`jv_editor`) REFERENCES `chief_editior` (`ce_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `write` (
  ...
  KEY `write_author_id_idx` (`author_id`),
  CONSTRAINT `write_author_id` FOREIGN KEY (`author_id`) REFERENCES `author` (`author_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `write_document_id` FOREIGN KEY (`doc_id`) REFERENCES `document` (`doc_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-12-11 19:47:16
