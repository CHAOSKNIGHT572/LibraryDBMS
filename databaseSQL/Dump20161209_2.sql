...
--
-- Table structure for table `cheif_editior`
--

DROP TABLE IF EXISTS `cheif_editior`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cheif_editior` (
...
CREATE TABLE `journal_volume` (
  ...
  CONSTRAINT `volume_editor_id` FOREIGN KEY (`jv_editor`) REFERENCES `cheif_editior` (`ce_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-12-09 16:49:18
